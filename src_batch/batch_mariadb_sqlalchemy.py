    ...
    for racine, sous_repertoires, fichiers in os.walk(chemin_racine):
         for fichier in fichiers:
            ...
            if fichier.endswith(".csv"):
                ...
                df, index_dict=traiter_fichier(connection,chemin_fichier, fichier,liste_nom_table,dtype, index_dict,liste_col_a_supprimer,dict_nom_fichier)
    return df, index_dict
...
if __name__ == '__main__':
 ...
 'northern-ireland': 'Police Service of Northern Ireland'}
    ...
    if connection:
        ...
        df, index_dict=parcourir_arborescence(connection,engine,chemin_racine, db_name,liste_nom_table,dtype,
